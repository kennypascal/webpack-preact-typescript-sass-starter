	...
	render(props: AppProps, state: AppState) {
		return (
			<div ref={(project) => (this.refApp = project)} className={classNames(COMPONENT_NAME)}>
				<img
					className={classNames('bkgd')}
					src={require('assets/img/sven-scheuermeier-37377-unsplash.jpg')}
					onLoad={this.onLoad}
				...
				<div className={classNames('content')}>
					...
					<div className={classNames('content__tools')}>
						<a
							...
							className={classNames('tool tool--webpack')}
							{...markDownHTML(require('assets/svg/icon-webpack.svg'))}
						/>
